                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    {legalData.map(({ title, info, icon }, index) => (
                        <View key={index} style={styles.menuItemWrapper}>
                            ...
                            {icon}
                            <Text numberOfLines={3} style={styles.info}>{info}</Text>
                        </View>
                    ))}
