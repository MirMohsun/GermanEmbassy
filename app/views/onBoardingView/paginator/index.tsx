        ...
        <View style={styles.container}>
            {data.map((_: any, index: number) => {
                ...
                const rDotStyle = useAnimatedStyle(() => {
                    const width = interpolate(progress.value, inputRange, [10, 40, 10], Extrapolate.CLAMP);
                    const backgroundColor = interpolateColor(progress.value, inputRange, [(color || "#76767a"), (color || "#38383D"), (color || "#76767a")]);
