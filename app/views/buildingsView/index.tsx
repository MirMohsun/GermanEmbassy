            ...
            <View style={styles.container}>
                ...
                <FlatList
                    ...
                    renderItem={(({ item, index }) => (
                        <TouchableOpacity onPress={() => navigation.navigate(ROUTES.BuildingPreView, { item })} activeOpacity={0.6} style={styles.menuButtonWrapper}>
                            <View style={{ ...styles.menuButton, paddingRight: index % 2 ? 0 : 6, paddingLeft: index % 2 ? 6 : 0 }}>
                                <Image source={{ uri: item.images[0]?.link }} style={{ width: "100%", height: 184, backgroundColor: "#EEEEEE" }} />
