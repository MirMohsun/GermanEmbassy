            ...
            <View style={styles.content}>
                <ScrollView showsVerticalScrollIndicator={false} style={{ marginTop: 20 }} contentContainerStyle={{ paddingBottom: isMore ? 140 : 30 }}>
                    ...
                    <View style={styles.architectWrapper}>
                        <Image source={{ uri: item.architect.img }} style={styles.cover} />
                        <View style={styles.architectNameWrapper}>
                            <Text numberOfLines={1} style={styles.label}>ARCHITECTS:</Text>
                            <Text numberOfLines={4} style={styles.info}>{item.architect.name}</Text>
                        </View>
                    </View>
                    <Text numberOfLines={1} style={styles.label}>LOCATION:</Text>
                    <Text numberOfLines={3} style={styles.info}>Ansion built in 1896 on 28 May, Baku, Azerbaijan</Text>
                    <Text numberOfLines={1} style={{ ...styles.label, marginTop: 24 }}>DATE:</Text>
